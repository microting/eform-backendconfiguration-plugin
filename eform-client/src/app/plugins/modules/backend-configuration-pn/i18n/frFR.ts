export const frFR = {
  ...
  'Enter board name': 'Entrez le nom du tableau',
  Cancel: 'Annuler',
  Create: 'Créer',
  ...
  'Are you sure you want to delete the board': 'Êtes-vous sûr de vouloir supprimer le tableau ?',
  'All tasks associated with this board will lose their board association': 'Toutes les tâches associées à ce conseil perdront leur association avec ce conseil.',
