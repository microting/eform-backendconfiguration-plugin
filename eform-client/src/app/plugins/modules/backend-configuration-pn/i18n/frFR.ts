export const frFR = {
  ...
  OK: 'OK',
  'My boards': 'Mes calendriers',
  'Task visible on board and shown in app': 'Tâche visible dans le calendrier et affichée dans l\'application',
  'Task dimmed on board and not shown in app': 'La tâche est grisée dans le calendrier et n\'apparaît pas dans l\'application.',
  Board: 'Calendrier',
  'Create board': 'Créer un calendrier',
  'Board name': 'Nom du calendrier',
  'Delete board': 'Supprimer le calendrier',
  'This will permanently delete the board and its {{count}} events. This cannot be undone.': 'Cette action supprimera définitivement le calendrier et ses {{count}} événements. Elle est irréversible.',
  'Enter board name': 'Saisissez le nom du calendrier',
  'Are you sure you want to delete the board': 'Êtes-vous sûr de vouloir supprimer le calendrier ?',
  'All tasks associated with this board will lose their board association': 'Toutes les tâches associées à ce calendrier perdront leur association avec ce calendrier.',
};
