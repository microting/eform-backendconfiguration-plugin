export const frFR = {
  ...
  Showing: 'Affichage',
  'Select filters and click Show report': 'Sélectionnez les filtres et cliquez sur Afficher le rapport',
  'No tasks in the selected period': 'Aucune tâche n&#39;est prévue pour la période sélectionnée.',
