export const esES = {
  ...
  'Board name': 'Nombre de la placa',
  'Delete board': 'Tablero de eliminación',
  'Enter board name': 'Ingrese el nombre del tablero',
  Cancel: 'Cancelar',
  Create: 'Crear',
  ...
  'Are you sure you want to delete the board': '¿Estás seguro de que quieres eliminar el tablero?',
  'All tasks associated with this board will lose their board association': 'Todas las tareas asociadas a esta junta perderán su asociación con la junta.',
