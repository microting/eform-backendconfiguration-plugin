export const esES = {
  ...
  GenerateWithTypeDoc: 'Generar {{type}}',
  ...
  'Yearly on {{day}} {{month}}': 'Anualmente el {{day}} {{month}}',
  Mon: 'Lun',
  Tue: 'Mar',
  Wed: 'Casarse',
  Thu: 'Jue',
  ...
  'Monthly on the {{ordinal}} {{day}}': 'Mensualmente en el {{ordinal}} {{day}}',
  'Every {{n}} months on the {{ordinal}} {{day}}': 'Cada {{n}} meses en el {{ordinal}} {{day}}',
