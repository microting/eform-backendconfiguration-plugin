export const esES = {
  ...
  OK: 'OK',
  'My boards': 'Mis calendarios',
  'Task visible on board and shown in app': 'La tarea es visible en el calendario y se muestra en la aplicación.',
  'Task dimmed on board and not shown in app': 'La tarea aparece atenuada en el calendario y no se muestra en la aplicación.',
  Board: 'Calendario',
  'Create board': 'Crear calendario',
  'Board name': 'Nombre del calendario',
  'Delete board': 'Eliminar calendario',
  'This will permanently delete the board and its {{count}} events. This cannot be undone.': 'Esto eliminará permanentemente el calendario y sus {{count}} eventos. Esta acción no se puede deshacer.',
  'Enter board name': 'Introduzca el nombre del calendario',
  'Are you sure you want to delete the board': '¿Estás seguro de que quieres eliminar el calendario?',
  'All tasks associated with this board will lose their board association': 'Todas las tareas asociadas a este calendario perderán su asociación con el calendario.',
};
