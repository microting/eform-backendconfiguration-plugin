export const etET = {
  ...
  Board: 'Juhatus',
  Search: 'Otsi',
  'Create board': 'Loo tahvel',
  'Board name': 'Juhatuse nimi',
  'Delete board': 'Kustuta tahvel',
  'Enter board name': 'Sisesta tahvli nimi',
  Cancel: 'Tühista',
  Create: 'Loo',
  ...
  'My tags': 'Minu sildid',
  'Are you sure you want to delete the board': 'Kas oled kindel, et soovid tahvli kustutada?',
  'All tasks associated with this board will lose their board association': 'Kõik selle tahvliga seotud ülesanded kaotavad oma seose tahvliga.',
