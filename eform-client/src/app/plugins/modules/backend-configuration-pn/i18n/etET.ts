export const etET = {
  ...
  OK: 'OK',
  'My boards': 'Minu kalendrid',
  'Task visible on board and shown in app': 'Ülesanne on kalendris nähtav ja kuvatakse rakenduses',
  'Task dimmed on board and not shown in app': 'Ülesanne on kalendris tuhm ja rakenduses seda ei kuvata',
  Board: 'Kalender',
  'Create board': 'Loo kalender',
  'Board name': 'Kalendri nimi',
  'Delete board': 'Kustuta kalender',
  'This will permanently delete the board and its {{count}} events. This cannot be undone.': 'See kustutab kalendri ja selle {{count}} sündmust jäädavalt. Seda toimingut ei saa tagasi võtta.',
  'Enter board name': 'Sisesta kalendri nimi',
  'Are you sure you want to delete the board': 'Kas oled kindel, et soovid kalendri kustutada?',
  'All tasks associated with this board will lose their board association': 'Kõik selle kalendriga seotud ülesanded kaotavad oma kalendriseose.',
};
