export const slSL = {
  ...
  Board: 'Odbor',
  Search: 'Iskanje',
  'Create board': 'Ustvari tablo',
  'Board name': 'Ime upravnega odbora',
  'Delete board': 'Izbriši tablo',
  'Enter board name': 'Vnesite ime plošče',
  Cancel: 'Prekliči',
  Create: 'Ustvari',
  'Team name': 'Ime ekipe',
  ...
  'My tags': 'Moje oznake',
  'Are you sure you want to delete the board': 'Ste prepričani, da želite izbrisati tablo?',
  'All tasks associated with this board will lose their board association': 'Vse naloge, povezane s to tablo, bodo izgubile povezavo s tablo.',
