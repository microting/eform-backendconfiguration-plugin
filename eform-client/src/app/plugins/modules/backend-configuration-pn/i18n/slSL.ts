export const slSL = {
  ...
  OK: 'OK',
  'My boards': 'Moji koledarji',
  'Task visible on board and shown in app': 'Opravilo je vidno v koledarju in prikazano v aplikaciji',
  'Task dimmed on board and not shown in app': 'Opravilo je v koledarju zatemnjeno in ni prikazano v aplikaciji',
  Board: 'Koledar',
  'Create board': 'Ustvari koledar',
  'Board name': 'Ime koledarja',
  'Delete board': 'Izbriši koledar',
  'This will permanently delete the board and its {{count}} events. This cannot be undone.': 'S tem boste trajno izbrisali koledar in {{count}} dogodkov v njem. Tega ni mogoče razveljaviti.',
  'Enter board name': 'Vnesite ime koledarja',
  'Are you sure you want to delete the board': 'Ste prepričani, da želite izbrisati koledar?',
  'All tasks associated with this board will lose their board association': 'Vsa opravila, povezana s tem koledarjem, bodo izgubila povezavo s koledarjem.',
};
