export const nlNL = {
  ...
  Board: 'Bord',
  Search: 'Zoekopdracht',
  'Create board': 'Maak een bord aan',
  'Board name': 'Bestuursnaam',
  'Delete board': 'Verwijder het bord',
  'Enter board name': 'Voer de bordnaam in',
  Cancel: 'Annuleren',
  Create: 'Creëren',
  'Team name': 'Teamnaam',
  ...
  'My tags': 'Mijn tags',
  'Are you sure you want to delete the board': 'Weet je zeker dat je het bord wilt verwijderen?',
  'All tasks associated with this board will lose their board association': 'Alle taken die aan dit bord zijn gekoppeld, verliezen hun bordkoppeling.',
