export const nlNL = {
  ...
  OK: 'OK',
  'My boards': 'Mijn agenda\'s',
  'Task visible on board and shown in app': 'Taak zichtbaar in de agenda en weergegeven in de app.',
  'Task dimmed on board and not shown in app': 'Taak grijs weergegeven in de agenda en niet zichtbaar in de app.',
  Board: 'Kalender',
  'Create board': 'Kalender maken',
  'Board name': 'Kalendernaam',
  'Delete board': 'Kalender verwijderen',
  'This will permanently delete the board and its {{count}} events. This cannot be undone.': 'Hiermee worden de kalender en de bijbehorende {{count}} gebeurtenissen permanent verwijderd. Deze actie kan niet ongedaan worden gemaakt.',
  'Enter board name': 'Voer de kalendernaam in',
  'Are you sure you want to delete the board': 'Weet je zeker dat je de agenda wilt verwijderen?',
  'All tasks associated with this board will lose their board association': 'Alle taken die aan deze agenda zijn gekoppeld, verliezen hun agendakoppeling.',
};
