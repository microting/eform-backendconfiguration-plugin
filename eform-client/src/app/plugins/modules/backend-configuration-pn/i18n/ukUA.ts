export const ukUA = {
  ...
  OK: 'OK',
  'My boards': 'Мої календарі',
  'Task visible on board and shown in app': 'Завдання відображається в календарі та додатку',
  'Task dimmed on board and not shown in app': 'Завдання затемнене в календарі та не відображається в додатку',
  Board: 'Календар',
  'Create board': 'Створити календар',
  'Board name': 'Назва календаря',
  'Delete board': 'Видалити календар',
  'This will permanently delete the board and its {{count}} events. This cannot be undone.': 'Це остаточно видалить календар та його {{count}} подій. Цю дію неможливо скасувати.',
  'Enter board name': 'Введіть назву календаря',
  'Are you sure you want to delete the board': 'Ви впевнені, що хочете видалити календар?',
  'All tasks associated with this board will lose their board association': 'Усі завдання, пов’язані з цим календарем, втратять зв’язок із календарем',
};
