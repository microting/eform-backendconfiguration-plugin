export const da = {
  ...
  'Only this': 'Kun dette',
  'This and following': 'Dette og følgende',
  ...
  'This task is part of a recurring series. What do you want to': 'Denne opgave er en del af en tilbagevendende serie. Hvad vil du',
  ID: 'ID',
  Save: 'Gem',
  Delete: 'Slet',
  Edit: 'Rediger',
