export const da = {
  ...
  'Task visible on board and shown in app': 'Opgave synlig i kalender og vises i app',
  'Task dimmed on board and not shown in app': 'Opgave nedtonet i kalender og vises ikke i app',
  ...
  Translate: 'Oversætte',
  Farve: 'Farve',
  'Create board': 'Opret kalender',
  'Board name': 'Kalendernavn',
  'Delete board': 'Slet kalender',
  'This will permanently delete the board and its {{count}} events. This cannot be undone.': 'Dette sletter kalenderen og dens {{count}} begivenheder permanent. Dette kan ikke fortrydes.',
  'Enter board name': 'Indtast kalendernavn',
  Cancel: 'Annuller',
  Create: 'Opret',
  'Team name': 'Holdnavn',
  ...
  'My tags': 'Mine tags',
  'Are you sure you want to delete the board': 'Er du sikker på, at du vil slette kalenderen',
  'All tasks associated with this board will lose their board association': 'Alle opgaver, der er knyttet til denne kalender, mister deres kalendertilknytning',
