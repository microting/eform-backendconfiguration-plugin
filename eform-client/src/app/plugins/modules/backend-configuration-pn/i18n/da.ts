export const da = {
  ...
  Title: 'Titel',
  'Set tags...': 'Vælg tags',
  'Assign to...': 'Vælg medarbejder / team',
  ...
  'Custom repeat': 'Brugerdefineret gentagelse',
  'Repeat on': 'Gentag på',
  Ends: 'Slutter',
  Never: 'Aldrig',
  On: 'Til og med',
  ...
  'Drive disconnected': 'Drev frakoblet',
  'Reconnect to resume sync': 'Genopret forbindelse for at genoptage synkronisering',
  'Synced from Google Drive': 'Synkroniseret fra Google Drev',
  'Could not connect to Google Drive': 'Kunne ikke oprette forbindelse til Google Drev',
  'Could not attach Drive file': 'Kunne ikke vedhæfte Drive-filen',
  'Google Drive connected': 'Google Drev er forbundet',
  'You can close this window': 'Du kan lukke dette vindue',
  'Open in Google Drive': 'Åbn i Google Drev',
  'Connected Google Drive accounts': 'Forbundne Google Drive-konti',
  'No Google Drive accounts connected.': 'Ingen Google Drive-konti er tilknyttet.',
  Disconnect: 'Afbryd',
  'Disconnect Google Drive?': 'Afbryd forbindelsen til Google Drev?',
  'Disconnecting will stop sync for any Drive-attached files.': 'Hvis du afbryder forbindelsen, stoppes synkroniseringen af alle filer, der er vedhæftet fra Drev.',
  'Connected on': 'Tilsluttet den',
  'Last used': 'Sidst brugt',
  'Drive disconnected — reconnect to resume sync': 'Drev afbrudt — genoptag forbindelse for at genoptage synkronisering',
  ...
  'Task visible on calendar and shown in app': 'Opgave synlig i kalender og vises i app',
  'Task dimmed on calendar and not shown in app': 'Opgave nedtonet i kalender og vises ikke i app',
  ...
  'This will permanently delete the calendar and its {{count}} events. This cannot be undone.': 'Dette sletter kalenderen og dens {{count}} begivenheder permanent. Dette kan ikke fortrydes.',
  'Enter calendar name': 'Indtast kalendernavn',
  Cancel: 'Annuller',
  Create: 'Opret',
  'Team name': 'Holdnavn',
  ...
  'Enter tag name': 'Indtast tagnavn',
  'Enter team name': 'Indtast holdnavn',
  Confirm: 'Bekræft',
  'Save changes': 'Gem ændringer',
  'Complete task': 'Færdiggør opgaven',
  'Only this': 'Kun denne',
  'This and following': 'Denne og følgende',
  'All in series': 'Alle i serien',
  'Date is required': 'Dato er påkrævet',
  'Open link': 'Åbn link',
  'No worker found': 'Ingen arbejder fundet',
  'My tags': 'Mine tags',
  'Are you sure you want to delete the calendar': 'Er du sikker på, at du vil slette kalenderen',
  'All tasks associated with this calendar will lose their calendar association': 'Alle opgaver, der er knyttet til denne kalender, mister deres kalendertilknytning',
  ID: 'ID',
  Save: 'Gem',
  Delete: 'Slet',
  Edit: 'Rediger',
  ...
  'Not completed tasks': 'Ikke udførte opgaver',
  ...
  'Show all': 'Vis alle',
  Showing: 'Viser',
  'Select filters and click Show report': 'Vælg filtre og klik Vis rapport',
  'No tasks in the selected period': 'Ingen opgaver i den valgte periode',
  'Delete log': 'Slet log',
  'This action cannot be undone': 'Handlingen kan ikke fortrydes',
  ...
  'This task is part of a recurring series. What do you want to edit?': 'Denne opgave er en del af en tilbagevendende serie. Hvad vil du redigere?',
  ...
  'tasks selected': 'opgaver valgt',
  'Show paginated': 'Vis pagineret',
  'From employee': 'Fra medarbejder',
  'To employee': 'Til medarbejder',
  'Move selected to employee': 'Flyt valgte til medarbejder',
  'Move from employee to employee': 'Flyt fra medarbejder til medarbejder',
  'Add employee': 'Tilføj medarbejder',
  'Change eForm': 'Skift eForm',
  ...
  // Adhoc dashboard (M5/F4) - "Task" ("Opgave"), "Assigned to" ("Tildelt"),
  // "Completed by" ("Udført af"), "Urgent" ("Haster"), "Copy task"
  // ("Kopiér opgave") and "Complete task" ("Færdiggør opgaven") already
  // exist above and are reused as-is rather than duplicated here.
  'Adhoc overview': 'Adhoc overblik',
  Overview: 'Overblik',
  History: 'Historik',
  'New task': 'Ny opgave',
  Content: 'Indhold',
  'Last deadline': 'Sidste frist',
  Overdue: 'Overskredet',
  Solved: 'Løste',
  Archived: 'Arkiverede',
  'With comments': 'Ja',
  'Without comments': 'Nej',
  'Choose who completes the task': 'Vælg hvem der udfører opgaven',
