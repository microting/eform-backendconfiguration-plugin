export const skSK = {
  ...
  'Board name': 'Názov predstavenstva',
  'Delete board': 'Odstrániť nástenku',
  'Enter board name': 'Zadajte názov nástenky',
  Cancel: 'Zrušiť',
  Create: 'Vytvoriť',
  ...
  'My tags': 'Moje značky',
  'Are you sure you want to delete the board': 'Naozaj chcete odstrániť túto nástenku?',
  'All tasks associated with this board will lose their board association': 'Všetky úlohy spojené s touto nástenkou stratia svoju asociáciu s nástenkou.',
