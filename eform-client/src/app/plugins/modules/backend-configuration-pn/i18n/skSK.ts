export const skSK = {
  ...
  OK: 'OK',
  'My boards': 'Moje kalendáre',
  'Task visible on board and shown in app': 'Úloha viditeľná v kalendári a zobrazená v aplikácii',
  'Task dimmed on board and not shown in app': 'Úloha je v kalendári zobrazená stmavená a nezobrazuje sa v aplikácii',
  Board: 'Kalendár',
  'Create board': 'Vytvoriť kalendár',
  'Board name': 'Názov kalendára',
  'Delete board': 'Odstrániť kalendár',
  'This will permanently delete the board and its {{count}} events. This cannot be undone.': 'Týmto sa natrvalo vymaže kalendár a jeho {{count}} udalostí. Túto akciu nie je možné vrátiť späť.',
  'Enter board name': 'Zadajte názov kalendára',
  'Are you sure you want to delete the board': 'Naozaj chcete odstrániť kalendár?',
  'All tasks associated with this board will lose their board association': 'Všetky úlohy spojené s týmto kalendárom stratia svoje priradenie ku kalendáru',
};
