export const noNO = {
  ...
  'Adhoc overview': 'Adhoc-oversikt',
  Overview: 'Oversikt',
  History: 'Historie',
  'New task': 'Ny oppgave',
  Content: 'Innhold',
  'Last deadline': 'Siste frist',
  Overdue: 'Forsinket',
  Solved: 'Løst',
  Archived: 'Arkivert',
  'With comments': 'Med kommentarer',
  'Without comments': 'Uten kommentarer',
  'Choose who completes the task': 'Velg hvem som fullfører oppgaven',
  'Task can be seen and completed by': 'Oppgaven kan sees og fullføres av',
  'Assigned only': 'Kun tildelt',
  Everyone: 'Alle',
  'Execute no later than and first display': 'Utfør senest og første visning',
  ...
  'Last 24 months': 'Siste 24 måneder',
  'Custom period': 'Tilpasset periode',
  Columns: 'Kolonner',
  Created: 'Opprettet',
  'No deadline': 'Ingen frist',
  'Deadline today': 'Frist i dag',
  '{{count}} days until deadline': '{{count}} dager til fristen',
  And: 'OG',
  Or: 'ELLER',
  Weekdays: 'Hverdager',
  'Deadline reminder': 'Påminnelse om frist',
  'First visibility reminder': 'Første påminnelse om synlighet',
  Comments: 'Kommentarer',
  Period: 'Periode',
  Filters: 'Filtre',
  From: 'Fra',
  To: 'Til',
  'Archive task': 'Arkivoppgave',
  created: 'Opprettet',
  assigned: 'Tildelt',
  completed: 'Fullført',
  archived: 'Arkivert',
  ...
  'Select a property to filter by area': 'Velg en eiendom for å filtrere etter område',
  'Tags in history (AND)': 'Tagger i historikken (OG)',
  'Search tags': 'Søk etter tagger …',
  'No tags match the search': 'Ingen tagger samsvarer med søket.',
  'No tags yet - create them under Overview': 'Ingen tagger ennå – opprett dem under Oversikt.',
  'Remove tag {{name}}': 'Fjern «{{name}}»',
  'None selected': 'Ingen valgt',
  'Active period': 'Aktiv periode',
  '{{from}} to {{to}} inclusive of both days': '{{from}} — {{to}} (inkludert begge dager).',
  'History completed tasks': 'Historikk – fullførte oppgaver',
  'Completed date': 'Fullført',
  'Task resolved status': 'Løst',
  'No tasks match the selected period, property, area and tags': 'Ingen oppgaver samsvarer med den valgte perioden, egenskapen, området og taggene.',
  'Previous page': 'Tidligere',
  'Next page': 'Neste',
  'Page {{page}} of {{pages}}': 'Side {{page}} av {{pages}}',
  hit: 'treff',
  hits: 'treff',
  'Show help text': 'Vis hjelpetekst',
  'Hide help text': 'Skjul hjelpetekst',
  'Completion date term': 'Ferdigstillelsesdato',
  'is the date of': 'er datoen for',
  'when the task was completed': '(når oppgaven var fullført).',
  is: 'er',
  'inclusive of both ends': 'inkludert begge ender',
  'whole days by calendar date': '(hele dager etter kalenderdato).',
  'Fixed periods are counted backwards from': 'Faste perioder telles baklengs fra',
  'Day presets term': '30 / 60 / 90 dager',
  'equal the stated number of calendar days including today': '= det oppgitte antallet kalenderdager inkludert i dag.',
  and: 'og',
  'equal the same calendar day shifted back': '= samme kalenderdag forskjøvet tilbake det antallet måneder (justert hvis dagen ikke finnes i den måneden).',
  'below the active period line narrow the list to': 'Under linjen «Aktiv periode:» avgrenser du listen til den valgte eiendommen og – når en eiendom er valgt – til ett bestemt område eller til',
  'all areas term': 'alle områder',
  'on that property': 'på den eiendommen.',
  'The area dropdown is only active once a specific property is selected': 'Nedtrekksmenyen for område er bare aktiv når du har valgt en bestemt eiendom (ikke «Alle eiendommer»).',
  'Tags AND term': 'Tagger (OG)',
  'when one or more tags are selected only tasks that have': ': når én eller flere tagger er valgt, vil bare oppgaver som har',
  'all term': 'alle',
  'selected tags are shown without selected tags every completed task in the period is included': 'Valgte tagger vises. Uten valgte tagger inkluderes alle fullførte oppgaver i perioden.',
  'can be hidden or shown with the header line': 'kan skjules eller vises med overskriftslinjen (standard: lukket). Gruppen samles',
  Add: 'Legge til',
  'Area name is empty or already exists': 'Områdenavnet er tomt eller finnes allerede',
  'Create areas': 'Opprett områder',
  'Create one or more areas on the selected property (one name per line)': 'Opprett ett eller flere områder på den valgte eiendommen (ett navn per linje)',
  'Delete area': 'Slett område',
  'Edit or delete areas for the selected property': 'Rediger eller slett områder for den valgte eiendommen',
  'Existing tasks keep their history': 'Eksisterende oppgaver beholder historikken sin',
  'Failed to create areas': 'Kunne ikke opprette områder',
  'Failed to delete area': 'Kunne ikke slette området',
  'Manage areas': 'Administrer områder',
  'No areas on this property yet': 'Ingen områder på denne eiendommen ennå',
  'One area name per line': 'Ett områdenavn per linje',
  'Rename area': 'Gi nytt navn til området',
  'Compliance %': 'Samsvarsprosent',
