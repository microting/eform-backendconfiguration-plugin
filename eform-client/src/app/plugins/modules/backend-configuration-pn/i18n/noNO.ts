export const noNO = {
  ...
  'Task visible on board and shown in app': 'Oppgave synlig i kalenderen og vist i appen',
  'Task dimmed on board and not shown in app': 'Oppgaven er nedtonet i kalenderen og vises ikke i appen',
  Board: 'Kalender',
  'Create board': 'Opprett kalender',
  'Board name': 'Kalendernavn',
  'Delete board': 'Slett kalenderen',
  'This will permanently delete the board and its {{count}} events. This cannot be undone.': 'Dette vil slette kalenderen og dens {{count}} hendelser permanent. Dette kan ikke angres.',
  'Enter board name': 'Skriv inn kalendernavn',
  'Are you sure you want to delete the board': 'Er du sikker på at du vil slette kalenderen',
  'All tasks associated with this board will lose their board association': 'Alle oppgaver som er knyttet til denne kalenderen, vil miste kalendertilknytningen sin',
};
