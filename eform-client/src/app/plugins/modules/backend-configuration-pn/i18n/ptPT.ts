export const ptPT = {
  ...
  Showing: 'Exibindo',
  'Select filters and click Show report': 'Selecione os filtros e clique em Mostrar relatório.',
  'No tasks in the selected period': 'Nenhuma tarefa no período selecionado.',
