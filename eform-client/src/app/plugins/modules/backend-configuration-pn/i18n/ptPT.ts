export const ptPT = {
  ...
  'Enter board name': 'Digite o nome do tabuleiro',
  Cancel: 'Cancelar',
  Create: 'Criar',
  ...
  'My tags': 'Minhas tags',
  'Are you sure you want to delete the board': 'Tem certeza de que deseja excluir o quadro?',
  'All tasks associated with this board will lose their board association': 'Todas as tarefas associadas a este quadro perderão sua associação com ele.',
