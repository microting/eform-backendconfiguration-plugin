export const csCZ = {
  ...
  'Board name': 'Název představenstva',
  'Delete board': 'Smazat nástěnku',
  'Enter board name': 'Zadejte název desky',
  Cancel: 'Zrušit',
  Create: 'Vytvořit',
  ...
  'My tags': 'Moje štítky',
  'Are you sure you want to delete the board': 'Jste si jisti, že chcete smazat nástěnku?',
  'All tasks associated with this board will lose their board association': 'Všechny úkoly spojené s touto nástěnkou ztratí svou asociaci s nástěnkou.',
