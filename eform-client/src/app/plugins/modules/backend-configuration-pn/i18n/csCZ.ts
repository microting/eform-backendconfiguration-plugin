export const csCZ = {
  ...
  '{{count}} tasks': '{{count}} úkolů',
  '{{count}} open occurrences will be retracted': '{{count}} otevřených výskytů bude staženo',
  '{{count}} completed will be preserved': '{{count}} dokončených bude zachováno',
  '{{count}} overdue tasks will be created': '{{count}} úkolů po termínu bude vytvořeno',
  ...
  'Adhoc overview': 'Přehled adhoc',
  Overview: 'Přehled',
  History: 'Dějiny',
  'New task': 'Nový úkol',
  Content: 'Obsah',
  'Last deadline': 'Poslední termín',
  Overdue: 'Po splatnosti',
  Solved: 'Vyřešeno',
  Archived: 'Archivováno',
  'With comments': 'S komentáři',
  'Without comments': 'Bez komentářů',
  'Choose who completes the task': 'Vyberte, kdo úkol dokončí',
  'Task can be seen and completed by': 'Úkol si může prohlédnout a dokončit',
  'Assigned only': 'Pouze přiřazeno',
  Everyone: 'Každý',
  'Execute no later than and first display': 'Provést nejpozději do prvního zobrazení',
  ...
  'Last 24 months': 'Posledních 24 měsíců',
  'Custom period': 'Vlastní období',
  Columns: 'Sloupce',
  Created: 'Vytvořeno',
  'No deadline': 'Žádný termín',
  'Deadline today': 'Uzávěrka dnes',
  '{{count}} days until deadline': '{{count}} dní do uzávěrky',
  And: 'A',
  Or: 'NEBO',
  Weekdays: 'Všední dny',
  'Deadline reminder': 'Připomenutí termínu',
  'First visibility reminder': 'První připomenutí viditelnosti',
  Comments: 'Komentáře',
  Period: 'Období',
  Filters: 'Filtry',
  From: 'Z',
  To: 'Na',
  'Archive task': 'Archivovat úlohu',
  created: 'Vytvořeno',
  assigned: 'Přiřazeno',
  completed: 'Dokončeno',
  archived: 'Archivováno',
  ...
  '60 days': '60 dní',
  '90 days': '90 dní',
  '6 months period': '6 měsíců',
  '12 months period': '12 měsíců',
  'Period and filter': 'Tečka a filtr',
  'All areas': 'Všechny oblasti',
  'Select a property to filter by area': 'Vyberte nemovitost pro filtrování podle oblasti',
  'Tags in history (AND)': 'Štítky v historii (A)',
  'Search tags': 'Vyhledávání štítků …',
  'No tags match the search': 'Žádné štítky neodpovídají vyhledávání.',
  'No tags yet - create them under Overview': 'Zatím žádné štítky – vytvořte je v části Přehled.',
  'Remove tag {{name}}': 'Odebrat „{{name}}“',
  'None selected': 'Žádné vybráno',
  'Active period': 'Aktivní období',
  '{{from}} to {{to}} inclusive of both days': '{{from}} — {{to}} (včetně obou dnů).',
  'History completed tasks': 'Historie – dokončené úkoly',
  'Completed date': 'Dokončeno',
  'Task resolved status': 'Vyřešeno',
  'No tasks match the selected period, property, area and tags': 'Žádné úkoly neodpovídají vybranému období, vlastnosti, oblasti a tagům.',
  'Previous page': 'Předchozí',
  'Next page': 'Další',
  'Page {{page}} of {{pages}}': 'Stránka {{page}} z {{pages}}',
  hit: 'hit',
  hits: 'hity',
  'Show help text': 'Zobrazit text nápovědy',
  'Hide help text': 'Skrýt text nápovědy',
  'Completion date term': 'Datum dokončení',
  'is the date of': 'je datum',
  'when the task was completed': '(když byl úkol dokončen).',
  is: 'je',
  'inclusive of both ends': 'včetně obou konců',
  'whole days by calendar date': '(celé dny podle kalendářního data).',
  'Fixed periods are counted backwards from': 'Pevné doby se počítají zpětně od',
  'Day presets term': '30 / 60 / 90 dní',
  'equal the stated number of calendar days including today': '= uvedený počet kalendářních dnů včetně dneška.',
  and: 'a',
  'equal the same calendar day shifted back': '= stejný kalendářní den posunutý o daný počet měsíců zpět (upraveno, pokud daný den v daném měsíci neexistuje).',
  'below the active period line narrow the list to': 'pod řádkem „Aktivní období:“ zúžit seznam na vybranou nemovitost a – po výběru nemovitosti – na jednu konkrétní oblast nebo na',
  'all areas term': 'všechny oblasti',
  'on that property': 'na daném pozemku.',
  'The area dropdown is only active once a specific property is selected': 'Rozbalovací nabídka oblastí je aktivní pouze po výběru konkrétní nemovitosti (ne „Všechny nemovitosti“).',
  'Tags AND term': 'Štítky (A)',
  'when one or more tags are selected only tasks that have': ': pokud je vybrán jeden nebo více štítků, zobrazí se pouze úkoly, které mají',
  'all term': 'vše',
  'selected tags are shown without selected tags every completed task in the period is included': 'Zobrazí se vybrané štítky. Bez vybraných štítků se zobrazí všechny dokončené úkoly v daném období.',
  'can be hidden or shown with the header line': 'lze skrýt nebo zobrazit s řádkem záhlaví (výchozí: zavřeno). Skupina se schází',
  Add: 'Přidat',
  'Area name is empty or already exists': 'Název oblasti je prázdný nebo již existuje.',
  'Create areas': 'Vytvořit oblasti',
  'Create one or more areas on the selected property (one name per line)': 'Vytvořte jednu nebo více oblastí na vybrané nemovitosti (jeden název na řádek)',
  'Delete area': 'Smazat oblast',
  'Edit or delete areas for the selected property': 'Úprava nebo odstranění oblastí pro vybranou nemovitost',
  'Existing tasks keep their history': 'Existující úkoly si uchovávají svou historii',
  'Failed to create areas': 'Vytvoření oblastí se nezdařilo',
  'Failed to delete area': 'Nepodařilo se smazat oblast',
  'Manage areas': 'Spravovat oblasti',
  'No areas on this property yet': 'Na této nemovitosti zatím nejsou žádné oblasti',
  'One area name per line': 'Jeden název oblasti na řádek',
  'Rename area': 'Přejmenovat oblast',
  'Compliance %': '% shody',
  'Compliance total': 'Celkový',
