export const csCZ = {
  ...
  OK: 'OK',
  'My boards': 'Moje kalendáře',
  'Task visible on board and shown in app': 'Úkol viditelný v kalendáři a zobrazený v aplikaci',
  'Task dimmed on board and not shown in app': 'Úkol je v kalendáři zobrazen šedě a v aplikaci se nezobrazuje',
  Board: 'Kalendář',
  'Create board': 'Vytvořit kalendář',
  'Board name': 'Název kalendáře',
  'Delete board': 'Smazat kalendář',
  'This will permanently delete the board and its {{count}} events. This cannot be undone.': 'Tímto se trvale smaže kalendář a jeho {{count}} událostí. Tuto akci nelze vrátit zpět.',
  'Enter board name': 'Zadejte název kalendáře',
  'Are you sure you want to delete the board': 'Opravdu chcete smazat kalendář?',
  'All tasks associated with this board will lose their board association': 'Všechny úkoly spojené s tímto kalendářem ztratí své přidružení ke kalendáři.',
};
