export const deDE = {
  ...
  OK: 'OK',
  'My boards': 'Meine Kalender',
  'Task visible on board and shown in app': 'Aufgabe im Kalender sichtbar und in der App angezeigt',
  'Task dimmed on board and not shown in app': 'Aufgabe im Kalender ausgegraut und in der App nicht angezeigt.',
  Board: 'Kalender',
  'Create board': 'Kalender erstellen',
  'Board name': 'Kalendername',
  'Delete board': 'Kalender löschen',
  'This will permanently delete the board and its {{count}} events. This cannot be undone.': 'Dadurch werden der Kalender und seine {{count}} Ereignisse endgültig gelöscht. Dieser Vorgang kann nicht rückgängig gemacht werden.',
  'Enter board name': 'Kalendernamen eingeben',
  'Are you sure you want to delete the board': 'Sind Sie sicher, dass Sie den Kalender löschen möchten?',
  'All tasks associated with this board will lose their board association': 'Alle mit diesem Kalender verknüpften Aufgaben verlieren ihre Kalenderverknüpfung.',
};
