export const deDE = {
  ...
  'Delete board': 'Forum löschen',
  'Enter board name': 'Boardnamen eingeben',
  Cancel: 'Stornieren',
  Create: 'Erstellen',
  'Team name': 'Teamname',
  ...
  'My tags': 'Meine Tags',
  'Are you sure you want to delete the board': 'Möchtest du das Board wirklich löschen?',
  'All tasks associated with this board will lose their board association': 'Alle mit diesem Board verbundenen Aufgaben verlieren ihre Board-Zugehörigkeit.',
