export const fiFI = {
  ...
  'Enter board name': 'Anna taulun nimi',
  Cancel: 'Peruuttaa',
  Create: 'Luoda',
  ...
  'Are you sure you want to delete the board': 'Oletko varma, että haluat poistaa taulun?',
  'All tasks associated with this board will lose their board association': 'Kaikki tähän tauluun liittyvät tehtävät menettävät yhteyden tauluun.',
