export const fiFI = {
  ...
  OK: 'OK',
  'My boards': 'Omat kalenterini',
  'Task visible on board and shown in app': 'Tehtävä näkyy kalenterissa ja sovelluksessa',
  'Task dimmed on board and not shown in app': 'Tehtävä himmennettynä kalenterissa eikä näy sovelluksessa',
  Board: 'Kalenteri',
  'Create board': 'Luo kalenteri',
  'Board name': 'Kalenterin nimi',
  'Delete board': 'Poista kalenteri',
  'This will permanently delete the board and its {{count}} events. This cannot be undone.': 'Tämä poistaa kalenterin ja sen {{count}} tapahtumaa pysyvästi. Tätä ei voi perua.',
  'Enter board name': 'Anna kalenterin nimi',
  'Are you sure you want to delete the board': 'Oletko varma, että haluat poistaa kalenterin?',
  'All tasks associated with this board will lose their board association': 'Kaikki tähän kalenteriin liittyvät tehtävät menettävät kalenteriyhteytensä.',
};
