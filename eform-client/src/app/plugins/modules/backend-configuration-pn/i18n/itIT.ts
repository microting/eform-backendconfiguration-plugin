export const itIT = {
  ...
  Board: 'Asse',
  Search: 'Ricerca',
  'Create board': 'Crea la bacheca',
  'Board name': 'Nome della bacheca',
  'Delete board': 'Eliminare la scheda',
  'Enter board name': 'Inserisci il nome della tavola',
  Cancel: 'Cancellare',
  Create: 'Creare',
  ...
  'My tags': 'I miei tag',
  'Are you sure you want to delete the board': 'Sei sicuro di voler eliminare la bacheca?',
  'All tasks associated with this board will lose their board association': 'Tutte le attività associate a questa bacheca perderanno la loro associazione alla bacheca',
