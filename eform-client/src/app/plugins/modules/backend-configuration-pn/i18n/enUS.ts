export const enUS= {
  ...
  'Task visible on board and shown in app': 'Task visible on calendar and shown in app',
  'Task dimmed on board and not shown in app': 'Task dimmed on calendar and not shown in app',
  ...
  Board: 'Calendar',
  Search: 'Search',
  'Create board': 'Create calendar',
  'Board name': 'Calendar name',
  'Delete board': 'Delete calendar',
  'This will permanently delete the board and its {{count}} events. This cannot be undone.': 'This will permanently delete the calendar and its {{count}} events. This cannot be undone.',
  'Enter board name': 'Enter calendar name',
  Cancel: 'Cancel',
  Create: 'Create',
  'Team name': 'Team name',
  ...
  'My tags': 'My tags',
  'Are you sure you want to delete the board': 'Are you sure you want to delete the calendar',
  'All tasks associated with this board will lose their board association': 'All tasks associated with this calendar will lose their calendar association',
  'This task is part of a recurring series. What do you want to': 'This task is part of a recurring series. What do you want to',
  ID: 'ID',
  Save: 'Save',
  Delete: 'Delete',
  Edit: 'Edit',
