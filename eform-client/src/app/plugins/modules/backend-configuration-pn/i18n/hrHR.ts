export const hrHR = {
  ...
  OK: 'OK',
  'My boards': 'Moji kalendari',
  'Task visible on board and shown in app': 'Zadatak vidljiv u kalendaru i prikazan u aplikaciji',
  'Task dimmed on board and not shown in app': 'Zadatak je zatamnjen u kalendaru i ne prikazuje se u aplikaciji',
  Board: 'Kalendar',
  'Create board': 'Izradi kalendar',
  'Board name': 'Naziv kalendara',
  'Delete board': 'Izbriši kalendar',
  'This will permanently delete the board and its {{count}} events. This cannot be undone.': 'Ovim će se trajno izbrisati kalendar i njegovi događaji ({{count}}). Ova radnja se ne može poništiti.',
  'Enter board name': 'Unesite naziv kalendara',
  'Are you sure you want to delete the board': 'Jeste li sigurni da želite izbrisati kalendar',
  'All tasks associated with this board will lose their board association': 'Svi zadaci povezani s ovim kalendarom izgubit će svoju povezanost s kalendarom',
};
