export const hrHR = {
  ...
  'Create board': 'Izradi ploču',
  'Board name': 'Naziv odbora',
  'Delete board': 'Izbriši ploču',
  'Enter board name': 'Unesite naziv ploče',
  Cancel: 'Otkazati',
  Create: 'Stvoriti',
  ...
  'My tags': 'Moje oznake',
  'Are you sure you want to delete the board': 'Jeste li sigurni da želite izbrisati ploču',
  'All tasks associated with this board will lose their board association': 'Svi zadaci povezani s ovom pločom izgubit će svoju povezanost s pločom',
