export const hrHR = {
  ...
  'Adhoc overview': 'Pregled ad hoc usluga',
  Overview: 'Pregled',
  History: 'Povijest',
  'New task': 'Novi zadatak',
  Content: 'Sadržaj',
  'Last deadline': 'Posljednji rok',
  Overdue: 'Dospjelo',
  Solved: 'Riješeno',
  Archived: 'Arhivirano',
  'With comments': 'S komentarima',
  'Without comments': 'Bez komentara',
  'Choose who completes the task': 'Odaberite tko će dovršiti zadatak',
  'Task can be seen and completed by': 'Zadatak se može vidjeti i dovršiti od strane',
  'Assigned only': 'Samo dodijeljeno',
  Everyone: 'Svi',
  'Execute no later than and first display': 'Izvršiti najkasnije do prvog prikaza',
  'Last 30 days': 'Posljednjih 30 dana',
  'Last 60 days': 'Posljednjih 60 dana',
  'Last 90 days': 'Posljednjih 90 dana',
  'Last 6 months': 'Posljednjih 6 mjeseci',
  'Last 12 months': 'Posljednjih 12 mjeseci',
  'Last 24 months': 'Posljednjih 24 mjeseca',
  'Custom period': 'Prilagođeno razdoblje',
  Columns: 'Kolumne',
  Created: 'Izrađeno',
  'No deadline': 'Nema roka',
  'Deadline today': 'Rok je danas',
  '{{count}} days until deadline': '{{count}} dana do roka',
  And: 'I',
  Or: 'ILI',
  Weekdays: 'Radnim danima',
  'Deadline reminder': 'Podsjetnik na rok',
  'First visibility reminder': 'Prvi podsjetnik na vidljivost',
  Comments: 'Komentari',
  Period: 'Razdoblje',
  Filters: 'Filtri',
  From: 'Iz',
  To: 'Do',
  'Archive task': 'Arhiviraj zadatak',
  created: 'Izrađeno',
  ...
  '60 days': '60 dana',
  '90 days': '90 dana',
  '6 months period': '6 mjeseci',
  '12 months period': '12 mjeseci',
  'Period and filter': 'Točka i filter',
  'All areas': 'Sva područja',
  'Select a property to filter by area': 'Odaberite nekretninu za filtriranje po području',
  'Tags in history (AND)': 'Oznake u povijesti (I)',
  'Search tags': 'Pretraži oznake …',
  'No tags match the search': 'Nijedna oznaka ne odgovara pretrazi.',
  'No tags yet - create them under Overview': 'Još nema oznaka — stvorite ih u odjeljku Pregled.',
  'Remove tag {{name}}': 'Ukloni «{{name}}»',
  'None selected': 'Nije odabrano',
  'Active period': 'Aktivno razdoblje',
  '{{from}} to {{to}} inclusive of both days': '{{from}} — {{to}} (uključujući oba dana).',
  'History completed tasks': 'Povijest — dovršeni zadaci',
  'Completed date': 'Završeno',
  'Task resolved status': 'Riješeno',
  'No tasks match the selected period, property, area and tags': 'Nijedan zadatak ne odgovara odabranom razdoblju, svojstvu, području i oznakama.',
  'Previous page': 'Prethodno',
  'Next page': 'Sljedeći',
  'Page {{page}} of {{pages}}': 'Stranica {{page}} od {{pages}}',
  hit: 'udarac',
  hits: 'pogoci',
  'Show help text': 'Prikaži tekst pomoći',
  'Hide help text': 'Sakrij tekst pomoći',
  'Completion date term': 'Datum završetka',
  'is the date of': 'je datum',
  'when the task was completed': '(kada je zadatak završen).',
  is: 'je',
  'inclusive of both ends': 'uključujući oba kraja',
  'whole days by calendar date': '(cijeli dani po kalendarskom datumu).',
  'Fixed periods are counted backwards from': 'Fiksna razdoblja se broje unatrag od',
  'Day presets term': '30 / 60 / 90 dana',
  'equal the stated number of calendar days including today': '= navedeni broj kalendarskih dana, uključujući današnji dan.',
  and: 'i',
  'equal the same calendar day shifted back': '= isti kalendarski dan pomaknut unatrag za taj broj mjeseci (prilagođeno ako dan ne postoji u tom mjesecu).',
  'below the active period line narrow the list to': 'ispod retka «Aktivno razdoblje:» suzite popis na odabranu nekretninu i — nakon što je nekretnina odabrana — na jedno određeno područje ili na',
  'all areas term': 'sva područja',
  'on that property': 'na toj nekretnini.',
  'The area dropdown is only active once a specific property is selected': 'Padajući izbornik područja aktivan je tek nakon što odaberete određenu nekretninu (ne «Sve nekretnine»).',
  'Tags AND term': 'Oznake (I)',
  'when one or more tags are selected only tasks that have': ': kada je odabrana jedna ili više oznaka, prikazuju se samo zadaci koji imaju',
  'all term': 'sve',
  'selected tags are shown without selected tags every completed task in the period is included': 'Prikazuju se odabrane oznake. Bez odabranih oznaka, uključen je svaki dovršeni zadatak u razdoblju.',
  'can be hidden or shown with the header line': 'može se sakriti ili prikazati s linijom zaglavlja (zadano: zatvoreno). Grupa se okuplja',
  Add: 'Dodati',
  'Area name is empty or already exists': 'Naziv područja je prazan ili već postoji',
  'Create areas': 'Stvori područja',
  'Create one or more areas on the selected property (one name per line)': 'Stvorite jedno ili više područja na odabranom objektu (jedno ime po retku)',
  'Delete area': 'Izbriši područje',
  'Edit or delete areas for the selected property': 'Uredite ili izbrišite područja za odabranu nekretninu',
  'Existing tasks keep their history': 'Postojeći zadaci čuvaju svoju povijest',
  'Failed to create areas': 'Nije uspjelo stvaranje područja',
  'Failed to delete area': 'Brisanje područja nije uspjelo',
  'Manage areas': 'Upravljanje područjima',
  'No areas on this property yet': 'Još nema područja na ovom imanju',
  'One area name per line': 'Jedan naziv područja po retku',
  'Rename area': 'Preimenuj područje',
  'Compliance %': '% usklađenosti',
  'Compliance total': 'Ukupno',
