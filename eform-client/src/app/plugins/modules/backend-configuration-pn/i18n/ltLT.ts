export const ltLT = {
  ...
  'Enter board name': 'Įveskite lentos pavadinimą',
  Cancel: 'Atšaukti',
  Create: 'Sukurti',
  ...
  'My tags': 'Mano žymės',
  'Are you sure you want to delete the board': 'Ar tikrai norite ištrinti lentą?',
  'All tasks associated with this board will lose their board association': 'Visos su šia lenta susietos užduotys praras savo sąsają su lenta',
