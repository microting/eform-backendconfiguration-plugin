export const huHU = {
  ...
  OK: 'OK',
  'My boards': 'Naptáraim',
  'Task visible on board and shown in app': 'A feladat látható a naptárban és az alkalmazásban',
  'Task dimmed on board and not shown in app': 'A feladat szürkítve jelenik meg a naptárban, és nem jelenik meg az alkalmazásban',
  Board: 'Naptár',
  'Create board': 'Naptár létrehozása',
  'Board name': 'Naptár neve',
  'Delete board': 'Naptár törlése',
  'This will permanently delete the board and its {{count}} events. This cannot be undone.': 'Ez véglegesen törli a naptárat és a benne lévő {{count}} eseményt. A művelet nem vonható vissza.',
  'Enter board name': 'Adja meg a naptár nevét',
  'Are you sure you want to delete the board': 'Biztosan törölni szeretné a naptárat?',
  'All tasks associated with this board will lose their board association': 'Az ehhez a naptárhoz társított összes feladat elveszíti a naptárhoz való társítását.',
};
