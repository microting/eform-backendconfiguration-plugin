export const huHU = {
  ...
  'Select filters and click Show report': 'Válasszon szűrőket, és kattintson a Jelentés megjelenítése gombra',
  'No tasks in the selected period': 'Nincsenek feladatok a kiválasztott időszakban',
