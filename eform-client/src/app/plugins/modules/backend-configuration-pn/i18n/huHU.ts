export const huHU = {
  ...
  'Enter board name': 'Írd be a tábla nevét',
  Cancel: 'Mégsem',
  Create: 'Teremt',
  ...
  'Are you sure you want to delete the board': 'Biztosan törölni szeretnéd a táblát?',
  'All tasks associated with this board will lose their board association': 'Az ehhez a táblához társított összes feladat elveszíti a táblához való társítását.',
