export const plPL = {
  ...
  OK: 'OK',
  'My boards': 'Moje kalendarze',
  'Task visible on board and shown in app': 'Zadanie widoczne w kalendarzu i wyświetlane w aplikacji',
  'Task dimmed on board and not shown in app': 'Zadanie jest przyciemnione w kalendarzu i nie jest wyświetlane w aplikacji',
  Board: 'Kalendarz',
  'Create board': 'Utwórz kalendarz',
  'Board name': 'Nazwa kalendarza',
  'Delete board': 'Usuń kalendarz',
  'This will permanently delete the board and its {{count}} events. This cannot be undone.': 'Spowoduje to trwałe usunięcie kalendarza i {{count}} wydarzeń. Tej czynności nie można cofnąć.',
  'Enter board name': 'Wprowadź nazwę kalendarza',
  'Are you sure you want to delete the board': 'Czy na pewno chcesz usunąć kalendarz?',
  'All tasks associated with this board will lose their board association': 'Wszystkie zadania powiązane z tym kalendarzem utracą swoje powiązanie z kalendarzem',
};
