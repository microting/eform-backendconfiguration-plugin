export const plPL = {
  ...
  'Weekly on {{day}}': 'Tygodniowo w {{day}}',
  'Monthly on day {{day}}': 'Miesięcznie w dniu {{day}}',
  'Yearly on {{day}} {{month}}': 'Rocznie w {{day}} {{month}}',
  Mon: 'Poniedziałek',
  Tue: 'wtorek',
  Wed: 'Poślubić',
  Thu: 'Czw',
  ...
  'Every {{n}} months on the {{ordinal}} {{day}}': 'Co {{n}} miesięcy w {{ordinal}} {{day}}',
  ...
  'Adhoc overview': 'Przegląd ad hoc',
  Overview: 'Przegląd',
  History: 'Historia',
  'New task': 'Nowe zadanie',
  Content: 'Treść',
  'Last deadline': 'Ostateczny termin',
  Overdue: 'Zaległy',
  Solved: 'Rozwiązany',
  Archived: 'Zarchiwizowane',
  'With comments': 'Z komentarzami',
  'Without comments': 'Bez komentarzy',
  'Choose who completes the task': 'Wybierz, kto wykona zadanie',
  'Task can be seen and completed by': 'Zadanie można zobaczyć i wykonać',
  'Assigned only': 'Tylko przypisane',
  Everyone: 'Wszyscy',
  'Execute no later than and first display': 'Wykonaj nie później niż i wyświetl jako pierwszy',
  ...
  'Deadline today': 'Termin mija dziś',
  '{{count}} days until deadline': '{{count}} dni do terminu',
  And: 'I',
  Or: 'LUB',
  Weekdays: 'Dni powszednie',
  'Deadline reminder': 'Przypomnienie o terminie',
  'First visibility reminder': 'Pierwsze przypomnienie o widoczności',
  Comments: 'Uwagi',
  Period: 'Okres',
  Filters: 'Filtry',
  From: 'Z',
  To: 'Do',
  'Archive task': 'Zadanie archiwalne',
  created: 'Stworzony',
  ...
  '60 days': '60 dni',
  '90 days': '90 dni',
  '6 months period': '6 miesięcy',
  '12 months period': '12 miesięcy',
  'Period and filter': 'Okres i filtr',
  'All areas': 'Wszystkie obszary',
  'Select a property to filter by area': 'Wybierz nieruchomość, aby filtrować według obszaru',
  'Tags in history (AND)': 'Tagi w historii (AND)',
  'Search tags': 'Szukaj tagów…',
  'No tags match the search': 'Brak tagów pasujących do wyszukiwania.',
  'No tags yet - create them under Overview': 'Brak tagów — utwórz je w Przeglądzie.',
  'Remove tag {{name}}': 'Usuń «{{name}}»',
  'None selected': 'Nie wybrano',
  'Active period': 'Okres aktywny',
  '{{from}} to {{to}} inclusive of both days': '{{from}} — {{to}} (wliczając oba dni).',
  'History completed tasks': 'Historia — ukończone zadania',
  'Completed date': 'Zakończony',
  'Task resolved status': 'Rozwiązany',
  'No tasks match the selected period, property, area and tags': 'Brak zadań odpowiadających wybranemu okresowi, właściwości, obszarowi i tagom.',
  'Previous page': 'Poprzedni',
  'Next page': 'Następny',
  'Page {{page}} of {{pages}}': 'Strona {{page}} z {{pages}}',
  hit: 'uderzyć',
  hits: 'trafienia',
  'Show help text': 'Pokaż tekst pomocy',
  'Hide help text': 'Ukryj tekst pomocy',
  'Completion date term': 'Data zakończenia',
  'is the date of': 'jest datą',
  'when the task was completed': '(gdy zadanie zostało ukończone).',
  is: 'Jest',
  'inclusive of both ends': 'obejmujący oba końce',
  'whole days by calendar date': '(całe dni według daty kalendarzowej).',
  'Fixed periods are counted backwards from': 'Okresy stałe liczone są wstecz od',
  'Day presets term': '30 / 60 / 90 dni',
  'equal the stated number of calendar days including today': '= podana liczba dni kalendarzowych, wliczając dzisiejszy dzień.',
  and: 'I',
  'equal the same calendar day shifted back': '= ten sam dzień kalendarzowy przesunięty o liczbę miesięcy do tyłu (skorygowany, jeśli w danym miesiącu dany dzień nie istnieje).',
  'below the active period line narrow the list to': 'poniżej wiersza „Okres aktywności:” zawęża listę do wybranej nieruchomości, a po wybraniu nieruchomości — do jednego konkretnego obszaru lub',
  'all areas term': 'wszystkie obszary',
  'on that property': 'na tej posesji.',
  'The area dropdown is only active once a specific property is selected': 'Lista rozwijana obszarów jest aktywna dopiero po wybraniu konkretnej nieruchomości (a nie „Wszystkie nieruchomości”).',
  'Tags AND term': 'Tagi (AND)',
  'when one or more tags are selected only tasks that have': ':gdy wybrany jest jeden lub więcej tagów, wyświetlane są tylko zadania, które mają',
  'all term': 'Wszystko',
  'selected tags are shown without selected tags every completed task in the period is included': 'Wyświetlane są wybrane tagi. Bez wybranych tagów uwzględniane jest każde zadanie ukończone w danym okresie.',
  'can be hidden or shown with the header line': 'można ukryć lub wyświetlić z linią nagłówka (domyślnie: zamkniętą). Grupa zbiera się',
  Add: 'Dodać',
  'Area name is empty or already exists': 'Nazwa obszaru jest pusta lub już istnieje',
  'Create areas': 'Utwórz obszary',
  'Create one or more areas on the selected property (one name per line)': 'Utwórz jeden lub więcej obszarów na wybranej nieruchomości (jedna nazwa w każdym wierszu)',
  'Delete area': 'Usuń obszar',
  'Edit or delete areas for the selected property': 'Edytuj lub usuń obszary dla wybranej nieruchomości',
  'Existing tasks keep their history': 'Istniejące zadania zachowują swoją historię',
  'Failed to create areas': 'Nie udało się utworzyć obszarów',
  'Failed to delete area': 'Nie udało się usunąć obszaru',
  'Manage areas': 'Zarządzaj obszarami',
  'No areas on this property yet': 'Na tej nieruchomości nie ma jeszcze żadnych obszarów',
  'One area name per line': 'Jedna nazwa obszaru na wiersz',
  'Rename area': 'Zmień nazwę obszaru',
  'Compliance %': 'Zgodność %',
  'Compliance total': 'Całkowity',
  ...
  Duplicate: 'Duplikuj',
  'A calendar with this name already exists': 'Kalendarz o tej nazwie już istnieje',
