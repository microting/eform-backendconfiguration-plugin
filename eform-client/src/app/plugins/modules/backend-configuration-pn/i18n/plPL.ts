export const plPL = {
  ...
  'Enter board name': 'Wprowadź nazwę tablicy',
  Cancel: 'Anulować',
  Create: 'Tworzyć',
  ...
  'My tags': 'Moje tagi',
  'Are you sure you want to delete the board': 'Czy na pewno chcesz usunąć tablicę?',
  'All tasks associated with this board will lose their board association': 'Wszystkie zadania powiązane z tą tablicą utracą swoje powiązanie z tablicą',
