export const svSE = {
  ...
  'Board name': 'Styrelsens namn',
  'Delete board': 'Ta bort anslagstavla',
  'Enter board name': 'Ange brädets namn',
  Cancel: 'Avboka',
  Create: 'Skapa',
  'Team name': 'Lagnamn',
  ...
  'My tags': 'Mina taggar',
  'Are you sure you want to delete the board': 'Är du säker på att du vill ta bort tavlan',
  'All tasks associated with this board will lose their board association': 'Alla uppgifter som är kopplade till detta forum kommer att förlora sin forumassociation',
