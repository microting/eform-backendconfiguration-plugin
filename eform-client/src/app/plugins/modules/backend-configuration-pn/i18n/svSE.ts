export const svSE = {
  ...
  OK: 'OK',
  'My boards': 'Mina kalendrar',
  'Task visible on board and shown in app': 'Uppgift synlig i kalendern och visas i appen',
  'Task dimmed on board and not shown in app': 'Uppgift nedtonad i kalendern och visas inte i appen',
  Board: 'Kalender',
  'Create board': 'Skapa kalender',
  'Board name': 'Kalendernamn',
  'Delete board': 'Ta bort kalender',
  'This will permanently delete the board and its {{count}} events. This cannot be undone.': 'Detta kommer att permanent radera kalendern och dess {{count}} händelser. Detta kan inte ångras.',
  'Enter board name': 'Ange kalendernamn',
  'Are you sure you want to delete the board': 'Är du säker på att du vill ta bort kalendern',
  'All tasks associated with this board will lose their board association': 'Alla uppgifter som är kopplade till den här kalendern kommer att förlora sin kalenderkoppling',
};
