export const isIS = {
  ...
  'Delete board': 'Eyða töflu',
  'Enter board name': 'Sláðu inn nafn borðsins',
  Cancel: 'Hætta við',
  Create: 'Búa til',
  'Team name': 'Nafn liðs',
  ...
  'My tags': 'Merkin mín',
  'Are you sure you want to delete the board': 'Ertu viss um að þú viljir eyða borðinu',
  'All tasks associated with this board will lose their board association': 'Öll verkefni sem tengjast þessu borði munu missa borðtengsl sín',
