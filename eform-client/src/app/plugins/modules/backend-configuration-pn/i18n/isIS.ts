export const isIS = {
  ...
  OK: 'OK',
  'My boards': 'Dagatölin mín',
  'Task visible on board and shown in app': 'Verkefni sýnilegt í dagatali og sýnt í appinu',
  'Task dimmed on board and not shown in app': 'Verkefni dimmt í dagatali og birtist ekki í appinu',
  Board: 'Dagatal',
  'Create board': 'Búa til dagatal',
  'Board name': 'Nafn dagatals',
  'Delete board': 'Eyða dagatali',
  'This will permanently delete the board and its {{count}} events. This cannot be undone.': 'Þetta mun eyða dagatalinu og {{count}} viðburðum þess fyrir fullt og allt. Þetta er ekki hægt að afturkalla.',
  'Enter board name': 'Sláðu inn nafn dagatalsins',
  'Are you sure you want to delete the board': 'Ertu viss um að þú viljir eyða dagatalinu',
  'All tasks associated with this board will lose their board association': 'Öll verkefni sem tengjast þessu dagatali munu missa dagatalstengingu sína',
};
