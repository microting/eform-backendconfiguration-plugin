export const elGR = {
  ...
  'Enter board name': 'Εισαγάγετε όνομα πίνακα',
  Cancel: 'Ματαίωση',
  Create: 'Δημιουργώ',
  ...
  'Are you sure you want to delete the board': 'Είστε σίγουροι ότι θέλετε να διαγράψετε τον πίνακα;',
  'All tasks associated with this board will lose their board association': 'Όλες οι εργασίες που σχετίζονται με αυτόν τον πίνακα θα χάσουν τη συσχέτισή τους με τον πίνακα.',
