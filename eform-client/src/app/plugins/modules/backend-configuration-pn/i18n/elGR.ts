export const elGR = {
  ...
  OK: 'OK',
  'My boards': 'Τα ημερολόγιά μου',
  'Task visible on board and shown in app': 'Η εργασία είναι ορατή στο ημερολόγιο και εμφανίζεται στην εφαρμογή',
  'Task dimmed on board and not shown in app': 'Η εργασία είναι απενεργοποιημένη στο ημερολόγιο και δεν εμφανίζεται στην εφαρμογή',
  Board: 'Ημερολόγιο',
  'Create board': 'Δημιουργία ημερολογίου',
  'Board name': 'Όνομα ημερολογίου',
  'Delete board': 'Διαγραφή ημερολογίου',
  'This will permanently delete the board and its {{count}} events. This cannot be undone.': 'Αυτό θα διαγράψει οριστικά το ημερολόγιο και τα {{count}} συμβάντα του. Δεν είναι δυνατή η αναίρεση αυτής της ενέργειας.',
  'Enter board name': 'Εισαγάγετε όνομα ημερολογίου',
  'Are you sure you want to delete the board': 'Είστε σίγουροι ότι θέλετε να διαγράψετε το ημερολόγιο;',
  'All tasks associated with this board will lose their board association': 'Όλες οι εργασίες που σχετίζονται με αυτό το ημερολόγιο θα χάσουν τη συσχέτισή τους με το ημερολόγιο.',
};
