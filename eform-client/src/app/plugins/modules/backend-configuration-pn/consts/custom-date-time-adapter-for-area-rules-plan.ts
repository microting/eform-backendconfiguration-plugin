...
export const MY_MOMENT_FORMATS_FOR_AREA_RULES_PLAN = {
  parseInput: MY_MOMENT_FORMATS.parseInput, // 'l LT',
  fullPickerInput: 'DD.MM.YYYY', //MY_MOMENT_FORMATS.fullPickerInput
  datePickerInput: 'DD.MM.YYYY', //MY_MOMENT_FORMATS.datePickerInput
  timePickerInput: 'DD.MM.YYYY', // MY_MOMENT_FORMATS.timePickerInput
