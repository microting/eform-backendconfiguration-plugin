  ...
  ngOnInit(): void {
    ...
    this.repeatTypeSub$ = repeatTypeControl!.valueChanges.subscribe((type: number) => {
      if (!type) {
        ...
        switch(type) {
          case RepeatTypeEnum.Day: this.repeatEveryOptions = this.repeatTypeDay; break;
          case RepeatTypeEnum.Week: this.repeatEveryOptions = this.repeatTypeWeek; break;
          case RepeatTypeEnum.Month: this.repeatEveryOptions = this.repeatTypeMonth; break;
          default: this.repeatEveryOptions = [];
        }
