...
{
    // Should test the UpdatePlanning method for area rule "00. Logbøger" for areaRule: 0 with repeat type "days" and repeat every "2"
    [Test]
    ...
    public async Task UpdatePlanning_AreaRule0Days2_ReturnsSuccess(int areaRuleNo, string danishTranslation, string englishTranslation, string germanTranslation)
    {
        // Arrange
